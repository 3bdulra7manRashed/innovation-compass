...
const steps = [
    ...
    { num: 3, title: "قياس نضج الابتكار المؤسسي", desc: "تأدية المقياس لتحديد الجاهزية الابتكارية للجهة.", phase: "التثقيف" },
...
const phaseColors: Record<string, string> = {
    ...
    "التثقيف": "bg-sky-500/10 text-sky-600 border-sky-500/20",
